...
import tu.kielce.bs.user.domain.events.ForbiddenPasswordEvent;
import tu.kielce.bs.user.domain.events.UserRegisteredEvent;
import tu.kielce.bs.user.domain.mappers.RegisterModelToUserCreateModelMapper;
import tu.kielce.bs.user.api.model.ForbiddenPasswordModel;
import tu.kielce.bs.user.api.model.RegisterModel;
import tu.kielce.bs.user.api.model.ResetPasswordModel;
import tu.kielce.bs.user.api.model.VerificationModel;
...
import tu.kielce.bs.user.domain.exceptions.UserExistsException;
